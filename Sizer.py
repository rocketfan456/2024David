...
for jj, thrust in enumerate(thrSweep): 
    ...
    for ii,mLaunch in enumerate(mSeparated):
        ...
        TCM2         = cf.Phase('TCM2', TCM2.mEnd,          5, engMain) # 5 m/s 
        TCM3         = cf.Phase('TCM3', TCM3.mEnd,          5, engMain) # 5 m/s 
        LOI          = cf.Phase('LOI',   LOI.mEnd,        850, engMain) # 850 m/s 
        TCM4         = cf.Phase('TCM4', TCM4.mEnd,          5, engMain) # 5 m/s 
        DOI          = cf.Phase('DOI',   DOI.mEnd,         25, engMain) # 25 m/s 
